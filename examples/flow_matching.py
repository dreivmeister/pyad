...
# ...existing code...
def odeint(f, y0, t, steps_per_interval=32, t_broadcast='match'):
    """
    Simple ODE integrator for pyad Tensors.
    - f: callable taking (y, t)
...
class VectorField(Module):
    ...
    def decode(self, z: Tensor) -> Tensor:
        # from noise to data
        return odeint(self, z, (1.0, 0.0), steps_per_interval=64)[-1]
...
v_t = VectorField(features = 2, hidden_features = [32] * 3)
